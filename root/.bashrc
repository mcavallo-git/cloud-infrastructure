...
#
# HOME_CONFIGS=( .bashrc .profile .vimrc ); for EACH_CONFIG in "${HOME_CONFIGS[@]}"; do curl -sL "https://raw.githubusercontent.com/mcavallo-git/cloud-infrastructure/master/root/${EACH_CONFIG}?t=$(date --utc +'%s.%N';)" -o "${HOME}/${EACH_CONFIG}"; chmod 0600 "${HOME}/${EACH_CONFIG}"; done;
#
# ------------------------------------------------------------
